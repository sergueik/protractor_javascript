...
describe('Protractor practice website - Friends Page', function() {
  ...
  describe('Friends Page', function() {
    ...
    var friendName = function(name) {
      return element.all(by.cssContainingText('td.ng-binding', name));
    };
    ...
    it('should add a friend', function() {
      var firstFriend = friendNames.get(0); // [object Object]
      expect(firstFriend.getText()).toEqual('Paul');
